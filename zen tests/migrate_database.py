"""
Script de migration pour corriger la structure de la base de données Neuro-Bot
"""
import os
import sqlite3
import sys
...
def main():
    ...
    print("=" * 60)
    print("🔧 MIGRATION DE LA BASE DE DONNÉES NEURO-BOT")
    print("=" * 60)
    ...
    response = input("\n❓ Voulez-vous procéder à la migration ? (oui/non): ").lower().strip()
